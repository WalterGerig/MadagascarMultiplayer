...
namespace MadMultiplayer {
    ...
    private:
        ...
        float m_flightSpeed{ 1.0f };
        int   m_flightHotkey{ 'N' }; // Standard Taste N (VK_N = 0x4E)
        bool  m_prevFlightHotkey{ false };

        // Teleportation & Waypoints
        float m_manualX{ 0.0f };
        float m_manualY{ 10.0f };
        float m_manualZ{ 0.0f };
